...
api_router.include_router(admin_intel.router, prefix="", tags=["Prodora Intelligence"])
api_router.include_router(admin_intake.router, prefix="", tags=["Prodora Intake"])
