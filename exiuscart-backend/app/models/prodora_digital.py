...
class ProdoraDigitalBundle(Base):
    ...
    code = Column(String(20), nullable=True)  # catalogue ID, DG001, DG002, ...
    ...
    # Admin-set flags: a flagged bundle also shows in Prodora's Current Trends /
    # Global Bestsellers views, next to the physical products.
    is_trending = Column(Boolean, default=False, server_default="false", nullable=False)
