        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSave} className="space-y-5">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6">
              ...
              <p className="text-gray-400 text-xs mb-5">Payouts are sent to your PayPal account only. Minimum payout is $100.</p>
        ...
        <div className="space-y-4">
          <div className="bg-white border border-gray-200 rounded-2xl p-5">
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              ...
              <li className="flex items-start gap-2">
                <span className="text-[#7B4FE9] mt-0.5">•</span>
                Method: <span className="text-gray-900 font-semibold ml-1">PayPal only</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#7B4FE9] mt-0.5">•</span>
