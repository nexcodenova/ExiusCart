...
export const CHANNEL_META: Record<string, {
  ...
  daraz:       { label: 'Daraz',          icon: ShoppingBag, color: 'text-orange-500', bg: 'bg-orange-500/10', logo: '/channel-logos/daraz.svg' },
  thedersi:    { label: 'TheDersi',       icon: Link2, color: 'text-primary', bg: 'bg-primary/10', logo: '/channel-logos/thedersi.jpg' },
