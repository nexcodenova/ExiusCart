...
export const variantsApi = {
  ...
  save: (shopId: string, productId: string, variants: {
    size?: string; color?: string; color_hex?: string; sku?: string; quantity: number; price?: number; cost_price?: number; image_url?: string;
...
export const channelsApi = {
  ...
  setChannelSiteUrl: (shopId: string, channelId: number, siteUrl: string | null) =>
    api.put(`/shops/${shopId}/channels/${channelId}/site-url`, { site_url: siteUrl }),
