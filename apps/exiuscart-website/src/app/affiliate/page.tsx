  ...
  return (
    <div className="min-h-screen bg-[#0B1121]">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 text-center">
        <div className="inline-flex items-center gap-2 bg-[#F5A623]/10 text-[#F5A623] border border-[#F5A623]/20 px-4 py-1.5 rounded-full text-sm font-medium mb-6">
          <Share2 className="w-4 h-4" />
          Affiliate Program
        </div>
        <h1 className="text-4xl lg:text-5xl font-bold text-white mb-4">
          Earn by sharing <span className="text-[#F5A623]">ExiusCart</span>
        </h1>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          {/* Shop Owner */}
          <div className="bg-[#151F32] rounded-2xl border-2 border-[#F5A623]/40 p-6 relative">
            <div className="absolute -top-3 right-4">
              <span className="bg-[#F5A623] text-black text-xs font-bold px-3 py-1 rounded-full">
                Higher Rates
              </span>
            </div>
            <div className="flex items-center gap-3 mb-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between bg-[#0B1121] rounded-xl px-4 py-3">
                ...
                <p className="text-2xl font-bold text-[#F5A623]">25%</p>
              </div>
              <div className="flex items-center justify-between bg-[#0B1121] rounded-xl px-4 py-3">
                <div>
                  <p className="text-xs text-gray-500">11+ referrals / month</p>
        ...
        <div className="mt-4 bg-[#F5A623]/5 border border-[#F5A623]/20 rounded-xl px-5 py-4 text-sm text-gray-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {HOW_IT_WORKS.map((step) => (
            <div key={step.step} className="bg-[#151F32] rounded-xl border border-gray-800 p-5 text-center">
              <div className="w-10 h-10 bg-[#F5A623] rounded-full flex items-center justify-center text-black font-bold text-lg mx-auto mb-4">
                {step.step}
              </div>
        ...
        <div className="bg-[#151F32] rounded-2xl border border-gray-800 p-6 lg:p-8">
          {submitted ? (
            <div className="text-center py-8">
              ...
              <Link href="/" className="inline-flex items-center gap-2 text-[#F5A623] hover:underline text-sm">
            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-3 mb-5">
                ...
                >
                  <Users className={`w-6 h-6 ${affiliateType === 'external' ? 'text-[#F5A623]' : 'text-gray-500'}`} />
                ...
                >
                  <Store className={`w-6 h-6 ${affiliateType === 'shop_owner' ? 'text-[#F5A623]' : 'text-gray-500'}`} />
                  <span className={`text-sm font-medium ${affiliateType === 'shop_owner' ? 'text-white' : 'text-gray-400'}`}>
                    I'm a Shop Owner
                  </span>
                  <span className="text-xs text-[#F5A623] font-medium">25% → 40%</span>
                </button>
              </div>

              {affiliateType === 'shop_owner' && (
                <div className="mb-5 px-4 py-3 bg-[#F5A623]/5 border border-[#F5A623]/20 rounded-lg text-sm text-gray-400">
                  <Zap className="w-4 h-4 text-[#F5A623] inline mr-1.5" />
              ...
              <div className="mb-5 flex items-center gap-4 bg-[#0B1121] rounded-xl px-4 py-3 text-sm">
                <DollarSign className="w-4 h-4 text-[#F5A623] flex-shrink-0" />
                <span className="text-gray-400">
                  Your rates:{' '}
                  <strong className="text-[#F5A623]">{rates.base}%</strong> for first 10 referrals/month,{' '}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-3.5 bg-[#F5A623] hover:bg-[#E09612] text-black font-bold rounded-xl transition flex items-center justify-center gap-2 text-base"
                >
                  {isLoading ? (
